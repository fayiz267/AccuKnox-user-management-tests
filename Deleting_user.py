...
with sync_playwright() as p:
    ...
    page.locator("xpath=/html/body/div/div[1]/div[2]/div[2]/div/div[2]/div[3]/div/div/div[2]/div/div/div[1]/div[2]/div/div/button[1]").click()
    page.wait_for_timeout(1000)

    page.locator("xpath=/html/body/div/div[3]/div/div/div/div[3]/button[2]").click()
    page.wait_for_timeout(1000)
